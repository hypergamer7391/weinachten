...
function createClass() {
  ...
  // Beispiel: Usernamen generieren (Klassenname + Nummer)
  for (let i = 1; i <= studentCount.value; i++) {
    usernames.value.push(`${className.value.replace(/\s+/g, '').toLowerCase()}${i}`)
  }

  // Hier könntest du die Klasse und Schüler in der Datenbank speichern
  // z.B. mit Firebase Firestore
